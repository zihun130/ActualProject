...
public class AttentionAdapter extends RecyclerView.Adapter<AttentionAdapter.SinglePersonalViewHolder> {
    private final Context context;
    private final List<AttentionBean.DataBean.ItemsBean.UsersBean> datas;
    private final LayoutInflater single;

    public AttentionAdapter(Context context, List<AttentionBean.DataBean.ItemsBean.UsersBean> users) {
    ...
    @Override
    public SinglePersonalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = single.inflate(R.layout.singlepersonal_item, parent, false);
        return new SinglePersonalViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(SinglePersonalViewHolder holder, int position) {
        AttentionBean.DataBean.ItemsBean.UsersBean usersBean = datas.get(position);
        Glide.with(context)
    ...
    class SinglePersonalViewHolder extends RecyclerView.ViewHolder {
        ...
        public SinglePersonalViewHolder(View inflate) {
            super(inflate);
            this.views=inflate;
